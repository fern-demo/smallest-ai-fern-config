...
<Update label="December 2024">
    ...
    Experience the new capabilities of Lightning Large via our [Platform](https://waves.smallest.ai) or the [API](/waves/v-3-0-1/api-reference/text-to-speech/lightning-v-31).
</Update>

...
<CardGroup cols={2}>
  <Card title="Transcription Endpoint" icon="microphone" href="/waves/guides/on-premise/api-reference/endpoints/transcription">
    Learn about the transcription API
  </Card>

  <Card title="Health Check" icon="heart-pulse" href="/waves/guides/on-premise/api-reference/endpoints/health-check">
    Monitor service health
  </Card>

  <Card title="Examples" icon="code" href="/waves/guides/on-premise/api-reference/examples">

...
<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/waves/guides/on-premise/api-reference/authentication">
    Learn about API authentication
  </Card>

  <Card title="Troubleshooting" icon="wrench" href="/waves/guides/on-premise/troubleshooting/common-issues">

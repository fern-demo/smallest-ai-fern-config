...
<Note>
  Ensure you've completed all [prerequisites](/waves/guides/on-premise/docker/stt/prerequisites) before
  starting this guide.
</Note>
...
<CardGroup cols={2}>
  <Card title="STT Configuration" icon="gear" href="/waves/guides/on-premise/docker/stt/configuration">
    Customize your deployment with advanced configuration options
  </Card>

  <Card title="STT Services Overview" icon="layer-group" href="/waves/guides/on-premise/docker/stt/services-overview">
    Learn about each service component in detail
  </Card>

  <Card title="STT Troubleshooting" icon="wrench" href="/waves/guides/on-premise/docker/stt/docker-troubleshooting">

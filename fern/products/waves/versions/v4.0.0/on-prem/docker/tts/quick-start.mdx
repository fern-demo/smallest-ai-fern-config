...
<Note>
Ensure you've completed all [prerequisites](/waves/guides/on-premise/docker/tts/prerequisites) before starting this guide.
</Note>
...
<CardGroup cols={2}>
  <Card title="TTS Configuration" icon="gear" href="/waves/guides/on-premise/docker/tts/configuration">
    Customize your TTS deployment with advanced configuration options
  </Card>

  <Card title="TTS Services Overview" icon="layer-group" href="/waves/guides/on-premise/docker/tts/services-overview">
    Learn about each TTS service component in detail
  </Card>

  <Card title="TTS Troubleshooting" icon="wrench" href="/waves/guides/on-premise/docker/tts/docker-troubleshooting">
    Debug common issues and optimize performance
  </Card>

  <Card title="API Reference" icon="code" href="/waves/guides/on-premise/api-reference/authentication">

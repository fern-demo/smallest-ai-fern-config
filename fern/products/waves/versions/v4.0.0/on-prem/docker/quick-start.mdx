...
<Note>
  Ensure you've completed all [prerequisites](/waves/guides/on-premise/docker/prerequisites) before
  starting this guide.
</Note>
...
<CardGroup cols={2}>
  <Card title="Configuration" icon="gear" href="/waves/guides/on-premise/docker/configuration">
    Customize your deployment with advanced configuration options
  </Card>

  <Card title="Services Overview" icon="layer-group" href="/waves/guides/on-premise/docker/services-overview">
    Learn about each service component in detail
  </Card>

  <Card title="Troubleshooting" icon="wrench" href="/waves/guides/on-premise/docker/docker-troubleshooting">

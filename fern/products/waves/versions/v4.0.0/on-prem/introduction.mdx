...
<CardGroup cols={2}>
      <Card title="Docker Deployment" icon="docker" href="/waves/guides/on-premise/docker/quick-start">
  ...
  <Card title="Kubernetes Deployment" icon="dharmachakra" href="/waves/guides/on-premise/kubernetes/quick-start">
...
<Card title="Start with Docker" icon="docker" href="/waves/guides/on-premise/docker/prerequisites">
  **Fastest path to get running** (15-30 minutes) Perfect if you're: -
  ...
  Docker Setup →](/waves/guides/on-premise/docker/prerequisites)
</Card>

### For Production Deployment

<CardGroup cols={2}>
  <Card title="Kubernetes on AWS" icon="aws" href="/waves/guides/on-premise/kubernetes/aws/eks-setup">
    **Full-featured production setup**
    ...
    [Setup AWS EKS →](/waves/guides/on-premise/kubernetes/aws/eks-setup)
  </Card>

  <Card title="Kubernetes (Generic)" icon="dharmachakra" href="/waves/guides/on-premise/kubernetes/prerequisites">
    **For any Kubernetes cluster**
    ...
    [Setup Kubernetes →](/waves/guides/on-premise/kubernetes/prerequisites)
  </Card>
</CardGroup>
...
<AccordionGroup>
  <Accordion title="I'm a DevOps Engineer" icon="terminal">
    Start here:
    1. [Kubernetes Prerequisites](/waves/guides/on-premise/kubernetes/prerequisites) - Check cluster requirements
    2. [AWS EKS Setup](/waves/guides/on-premise/kubernetes/aws/eks-setup) - Create EKS cluster (if on AWS)
    3. [Quick Start](/waves/guides/on-premise/kubernetes/quick-start) - Deploy with Helm
    4. [Autoscaling](/waves/guides/on-premise/kubernetes/autoscaling/hpa-configuration) - Configure HPA
    5. [Monitoring](/waves/guides/on-premise/kubernetes/autoscaling/grafana-dashboards) - Setup Grafana
  </Accordion>

{" "}

<Accordion title="I'm a Developer" icon="code">
  Start here: 1. [Docker Prerequisites](/waves/guides/on-premise/docker/prerequisites) - Setup local
  environment 2. [Docker Quick Start](/waves/guides/on-premise/docker/quick-start) - Get running in
  15 minutes 3. [API Reference](/waves/guides/on-premise/api-reference/authentication) - Integrate with
  your app 4. [Examples](/waves/guides/on-premise/api-reference/examples) - See code examples
</Accordion>

{" "}

<Accordion title="I'm Evaluating the Product" icon="magnifying-glass">
  Start here: 1. [Docker Quick Start](/waves/guides/on-premise/docker/quick-start) - Fastest way to
  test 2. [API Reference](/waves/guides/on-premise/api-reference/endpoints/transcription) - See what you
  can do 3. [Common Issues](/waves/guides/on-premise/troubleshooting/common-issues) - Get help if stuck
  4. Then move to [Kubernetes](/waves/guides/on-premise/kubernetes/quick-start) for production
</Accordion>

  <Accordion title="I Need Help" icon="life-ring">
    Resources:
    - [Common Issues](/waves/guides/on-premise/troubleshooting/common-issues) - Quick fixes
    - [Debugging Guide](/waves/guides/on-premise/troubleshooting/debugging-guide) - Advanced troubleshooting
    - [Logs Analysis](/waves/guides/on-premise/troubleshooting/logs-analysis) - Interpret error messages

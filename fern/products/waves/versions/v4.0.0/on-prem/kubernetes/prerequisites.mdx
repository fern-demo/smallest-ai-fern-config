...
<Warning>
**Kubernetes deployment is currently only available for ASR (Speech-to-Text).** TTS (Text-to-Speech) Kubernetes support is coming soon. For TTS deployments, please use [Docker](/waves/guides/on-premise/docker/tts/quick-start).
</Warning>
...
<Tip>
See the [AWS Deployment](/waves/guides/on-premise/kubernetes/aws/eks-setup) guide for detailed setup instructions.
</Tip>
...
<Tip>
See the [Cluster Autoscaler](/waves/guides/on-premise/kubernetes/autoscaling/cluster-autoscaler) guide for setup.
</Tip>
...
<Card title="AWS EKS Setup" icon="aws" href="/waves/guides/on-premise/kubernetes/aws/eks-setup">
...
<Card title="Quick Start" icon="rocket" href="/waves/guides/on-premise/kubernetes/quick-start">

...
<Warning>
Kubernetes deployment is currently available for **ASR (Speech-to-Text)** only. For TTS deployments, use [Docker](/waves/guides/on-premise/docker/tts/quick-start).
</Warning>

<Note>
Ensure you've completed all [prerequisites](/waves/guides/on-premise/kubernetes/prerequisites) before starting.
</Note>
...
For detailed troubleshooting, see [Troubleshooting Guide](/waves/guides/on-premise/kubernetes/k8s-troubleshooting).

## Next Steps

<CardGroup cols={2}>
  <Card title="AWS Setup" icon="aws" href="/waves/guides/on-premise/kubernetes/aws/eks-setup">
    EKS-specific configuration
  </Card>

  <Card title="Model Storage" icon="hard-drive" href="/waves/guides/on-premise/kubernetes/storage/model-storage">
    Shared storage for faster cold starts
  </Card>

  <Card title="Advanced Autoscaling" icon="chart-line" href="/waves/guides/on-premise/kubernetes/autoscaling/hpa-configuration">
    Fine-tune scaling behavior and thresholds
  </Card>

  <Card title="Monitoring" icon="chart-bar" href="/waves/guides/on-premise/kubernetes/autoscaling/grafana-dashboards">

...
<Tip>
For complete cost savings during off-hours, use [Cluster Autoscaler](/waves/guides/on-premise/kubernetes/autoscaling/cluster-autoscaler) to scale nodes to zero.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="Monitor HPA Decisions" icon="chart-line">
    ...
    See [Grafana Dashboards](/waves/guides/on-premise/kubernetes/autoscaling/grafana-dashboards)
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Cluster Autoscaler" icon="arrows-up-down" href="/waves/guides/on-premise/kubernetes/autoscaling/cluster-autoscaler">
  ...
  <Card title="Grafana Dashboards" icon="chart-line" href="/waves/guides/on-premise/kubernetes/autoscaling/grafana-dashboards">

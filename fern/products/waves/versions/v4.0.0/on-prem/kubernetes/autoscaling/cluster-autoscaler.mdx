...
<Steps>
  <Step title="IAM Role">
    Create IAM role with autoscaling permissions (see [IAM & IRSA](/waves/guides/on-premise/kubernetes/aws/iam-irsa))
  </Step>
...
Update IAM policy if needed (see [IAM & IRSA](/waves/guides/on-premise/kubernetes/aws/iam-irsa))
...
<CardGroup cols={2}>
  ...
  <Card title="Grafana Dashboards" icon="dashboard" href="/waves/guides/on-premise/kubernetes/autoscaling/grafana-dashboards">

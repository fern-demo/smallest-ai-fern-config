...
See [EFS Configuration](/waves/guides/on-premise/kubernetes/storage/efs-configuration) for setup.
...
<CardGroup cols={2}>
  ...
  <Card title="Redis Persistence" icon="database" href="/waves/guides/on-premise/kubernetes/storage/redis-persistence">

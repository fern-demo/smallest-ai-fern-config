...
<Steps>
  <Step title="EFS CSI Driver">
    Install the EFS CSI driver (see [IAM & IRSA](/waves/guides/on-premise/kubernetes/aws/iam-irsa) guide)
...
<CardGroup cols={2}>
  <Card title="Model Storage" icon="database" href="/waves/guides/on-premise/kubernetes/storage/model-storage">

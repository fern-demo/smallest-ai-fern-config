...
See the [Cluster Autoscaler](/waves/guides/on-premise/kubernetes/autoscaling/cluster-autoscaler) guide for detailed setup.
...
<CardGroup cols={2}>
  <Card title="IAM & IRSA" icon="shield" href="/waves/guides/on-premise/kubernetes/aws/iam-irsa">
    Configure IAM roles for service accounts
  </Card>

  <Card title="GPU Nodes" icon="server" href="/waves/guides/on-premise/kubernetes/aws/gpu-nodes">
    Advanced GPU node configuration and optimization
  </Card>

  <Card title="EFS Configuration" icon="folder" href="/waves/guides/on-premise/kubernetes/storage/efs-configuration">
    Set up shared file storage for models
  </Card>

  <Card title="Cluster Autoscaler" icon="chart-line" href="/waves/guides/on-premise/kubernetes/autoscaling/cluster-autoscaler">

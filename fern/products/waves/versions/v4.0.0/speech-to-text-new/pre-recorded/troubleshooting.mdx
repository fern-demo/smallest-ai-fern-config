...
description: 'Resolve common issues when uploading pre-recorded audio to Lightning STT'
---
...
- Normalize and denoise audio before uploading (see [best practices](/v4.0.0/content/speech-to-text-new/pre-recorded/best-practices)).

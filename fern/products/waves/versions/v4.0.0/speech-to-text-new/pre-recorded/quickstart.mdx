...
Head over to the [smallest console](https://console.smallest.ai/apikeys) to generate an API key, if not done previously. Also look at [Authentication guide](/waves/guides/getting-started/authentication) for more information about API keys and their usage.

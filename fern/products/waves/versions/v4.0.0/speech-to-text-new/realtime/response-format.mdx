...
<Note>
The `full_transcript` field is a feature that requires the `full_transcript` query parameter to be set to `true`. Learn more about the [Full Transcript feature](/v4.0.0/content/speech-to-text-new/features/full-transcript).
</Note>

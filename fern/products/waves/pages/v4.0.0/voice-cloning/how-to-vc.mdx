...
<Card title="Join the Community" icon="fa-brands fa-discord" href="https://discord.gg/ywShEyXHBW">
  Connect with other developers and get real-time support on Discord.
</Card>

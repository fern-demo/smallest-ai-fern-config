...
| `format`              | string | `true`  | Enable punctuation and capitalization formatting in transcript responses. Options: `true`, `false` |
| `eou_timeout_ms`      | number | `800`   | Time in milliseconds to wait after speech ends before flushing transcript. Range: `100` to `10000` |

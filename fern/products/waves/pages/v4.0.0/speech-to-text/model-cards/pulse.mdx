...
Full model card with performance benchmarks, accuracy metrics, and comparison data is in progress. For current capabilities, see the [Pulse API Reference](/waves/api-reference) and [STT Benchmarks](/waves/documentation/speech-to-text/benchmarks/performance).

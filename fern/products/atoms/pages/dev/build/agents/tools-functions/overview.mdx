...
<CardGroup cols={2}>
  ...
  <Card title="Executing Tools" icon="play" href="/atoms/developer-guide/build/agents/executing-tools">
    ToolRegistry, handling calls, and feeding results back.
  </Card>
  <Card title="Built-in Actions" icon="bolt" href="/atoms/developer-guide/build/agents/built-in-tools">

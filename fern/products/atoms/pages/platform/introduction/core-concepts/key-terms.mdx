...
<CardGroup cols={2}>
  <Card title="Create Your Account" icon="user-plus" href="/atoms/atoms-platform/introduction/quick-start">
    Set up your Atoms account
  </Card>
  <Card title="Your First Agent" icon="rocket" href="/atoms/atoms-platform/introduction/quick-start">

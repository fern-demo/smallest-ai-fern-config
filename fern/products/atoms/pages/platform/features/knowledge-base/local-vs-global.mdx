...
<CardGroup cols={2}>
  <Card title="Best Practices" icon="star" href="/atoms/atoms-platform/features/knowledge-base">
    Optimize your Knowledge Base
  </Card>
  <Card title="What is Knowledge Base" icon="book" href="/atoms/atoms-platform/features/knowledge-base">
    Back to overview
  </Card>
</CardGroup>

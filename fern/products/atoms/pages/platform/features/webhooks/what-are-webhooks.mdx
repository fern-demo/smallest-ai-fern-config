...
→ See: [Event Payloads](/atoms/atoms-platform/features/webhooks) for detailed schemas
...
<CardGroup cols={2}>
  <Card title="Creating Endpoints" icon="plus" href="/atoms/atoms-platform/features/webhooks">
    Set up your webhook endpoints
  </Card>
  <Card title="Event Payloads" icon="code" href="/atoms/atoms-platform/features/webhooks">

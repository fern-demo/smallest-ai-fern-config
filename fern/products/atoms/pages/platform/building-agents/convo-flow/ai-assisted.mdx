...
<CardGroup cols={2}>
  <Card title="Refine Your Flow" icon="diagram-project" href="/atoms/atoms-platform/conversational-flow-agents/workflow-tab/workflow-builder">
    Adjust nodes and branches
  </Card>
  <Card title="Learn Node Types" icon="shapes" href="/atoms/atoms-platform/conversational-flow-agents/workflow-tab/node-types">

...
<CardGroup cols={2}>
  <Card title="Creating Your Agent" icon="plus" href="/atoms/atoms-platform/conversational-flow-agents/creating-your-agent/manual-setup">
    Start building a Conversational Flow agent
  </Card>
  <Card title="Single Prompt: When to Use" icon="message-lines" href="/atoms/atoms-platform/single-prompt-agents/overview">

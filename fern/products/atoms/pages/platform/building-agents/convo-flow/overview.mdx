...
<CardGroup cols={3}>
  <Card title="Manual Setup" icon="hammer" href="/atoms/atoms-platform/conversational-flow-agents/creating-your-agent/manual-setup">
    Build flows from scratch
  </Card>
  <Card title="From Template" icon="copy" href="/atoms/atoms-platform/conversational-flow-agents/creating-your-agent/from-template">
    Start with pre-built flows
  </Card>
  <Card title="AI-Assisted" icon="sparkles" href="/atoms/atoms-platform/conversational-flow-agents/creating-your-agent/manual-setup">
    Let AI design your flow
  </Card>
</CardGroup>

<Card title="Workflow Builder Deep Dive" icon="diagram-project" href="/atoms/atoms-platform/conversational-flow-agents/workflow-tab/workflow-builder">

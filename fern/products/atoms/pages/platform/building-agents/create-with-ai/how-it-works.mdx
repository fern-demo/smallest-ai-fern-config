...
<CardGroup cols={2}>
  <Card title="Configuration Options" icon="sliders" href="/atoms/atoms-platform/single-prompt-agents/creating-your-agent/ai-assisted">
    Understand all settings
  </Card>
  <Card title="Writing the Four Prompts" icon="list-ol" href="/atoms/atoms-platform/single-prompt-agents/creating-your-agent/ai-assisted">
